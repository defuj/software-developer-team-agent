...
- [Frontend Developer.agent.md](<../agents/Frontend Developer.agent.md>) - Agent internals
...
### [Frontend Developer.agent.md](<../agents/Frontend Developer.agent.md>) - Agent Definition
